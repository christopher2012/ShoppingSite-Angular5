...
Test('/pos', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test po_list get operation', function (t) {
            Mockgen().requests({
                path: '/pos',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/pos']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test po_create post operation', function (t) {
            Mockgen().requests({
                path: '/pos',
                operation: 'post'
            }, function (err, mock) {
