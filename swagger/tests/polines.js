...
Test('/polines', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test poline_list get operation', function (t) {
            Mockgen().requests({
                path: '/polines',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/polines']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test poline_create post operation', function (t) {
            Mockgen().requests({
                path: '/polines',
                operation: 'post'
            }, function (err, mock) {
