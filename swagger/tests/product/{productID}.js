...
/**
 * Test for /product/{productID}
 */
Test('/product/{productID}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 404
         */
        t.test('test product_update put operation', function (t) {
            Mockgen().requests({
         ...
         * responses: 200, 404
         */
        t.test('test product_delete delete operation', function (t) {
            Mockgen().requests({
                path: '/product/{productID}',
                operation: 'delete'
            }, function (err, mock) {
