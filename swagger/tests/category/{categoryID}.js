...
/**
 * Test for /category/{categoryID}
 */
Test('/category/{categoryID}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 404
         */
        t.test('test category_update put operation', function (t) {
            Mockgen().requests({
         ...
         * responses: 200, 404
         */
        t.test('test category_delete delete operation', function (t) {
            Mockgen().requests({
                path: '/category/{categoryID}',
                operation: 'delete'
            }, function (err, mock) {
