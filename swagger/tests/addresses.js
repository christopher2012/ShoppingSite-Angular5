...
Test('/addresses', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test address_list get operation', function (t) {
            Mockgen().requests({
                path: '/addresses',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/addresses']['get']['responses']['200']['schema']);
         ...
         * responses: 200
         */
        t.test('test address_create post operation', function (t) {
            Mockgen().requests({
                path: '/addresses',
                operation: 'post'
            }, function (err, mock) {
