...
/**
 * Test for /address/{addressID}
 */
Test('/address/{addressID}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 404
         */
        t.test('test address_update put operation', function (t) {
            Mockgen().requests({
         ...
         * responses: 200, 404
         */
        t.test('test address_delete delete operation', function (t) {
            Mockgen().requests({
                path: '/address/{addressID}',
                operation: 'delete'
            }, function (err, mock) {
