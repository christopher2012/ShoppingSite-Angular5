...
/**
 * Test for /poline/{polineID}
 */
Test('/poline/{polineID}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 404
         */
        t.test('test poline_update put operation', function (t) {
            Mockgen().requests({
         ...
         * responses: 200, 404
         */
        t.test('test poline_delete delete operation', function (t) {
            Mockgen().requests({
                path: '/poline/{polineID}',
                operation: 'delete'
            }, function (err, mock) {
