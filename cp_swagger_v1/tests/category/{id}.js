...
/**
 * Test for /category/{id}
 */
Test('/category/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test category_getById get operation', function (t) {
            Mockgen().requests({
                path: '/category/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/category/{id}']['get']['responses']['200']['schema']);
